    ...
    <div  className={`glass-effect rounded-2xl overflow-hidden mt-20 md:mt-24 shadow-2xl w-full md:max-w-7xl mx-auto h-[122vh] md:max-h-[80vh]`}>
      ...
      <div className={`${styles.paddingX} w-full md:max-w-7xl mx-auto box  rounded-2xl shadow-2xl
       glass-effect flex flex-col md:flex-row justify-center md:justify-between items-center`}>
         ...
         <div className='glass-effect w-full rounded-2xl  md:max-w-1/2 h-full pb-6 text-left sm:text-left px-2'>
          <div className=''>
          <div className=''>
<div className='mt-6'>


<div className="wrapper h-10 flex items-center justify-center sm:justify-start text-center">
<h3 className='text-xl text-gray-gradient font-mono'>Hello <span className='font-mono'>I'm </span> Charis </h3>
  ...
  <h1 className='text-4xl sm:text-4xl mt-2'>VISUAL DESIGNER</h1>
       ...
       <button className='w-full md:w-fit bg-darker flex items-center justify-center gap-2 text-base sm:text-lg text-neutral-500 font-normal p-4 rounded-tr-2xl rounded-bl-2xl uppercase'>
